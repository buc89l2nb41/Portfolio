...
window.projects = [
  {
    title: "GrowRoll",
    summary: "성장·수집 루프를 중심으로 한 TypeScript 웹 게임 실험.",
  ...
  },
  {
    ...
    summary: "PersonaChat을 뒷받침하는 서버 사이드 구현.",
  ...
  },
  {
    ...
    summary: "PocketBase를 활용한 보드/게시판형 웹 애플리케이션.",
    stack: ["TypeScript", "PocketBase"],
  ...
  },
  {
    ...
    summary: "AI로 플레이리스트를 구성하는 실험적인 웹 앱.",
    stack: ["JavaScript", "AI"],
  ...
  },
  {
    ...
    summary: "프롬프트 기반 에셋 생성 파이프라인을 위한 Python 도구.",
    stack: ["Python", "AI"],
  ...
  },
  {
    ...
    summary: "로우폴리 비주얼을 활용한 TypeScript 실험 프로젝트.",
    stack: ["TypeScript", "3D"],
